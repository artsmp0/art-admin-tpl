  ...
  shortcuts: [
    {
      ...
      'o-demo_wrapper':
        'p5 border border-light-700 rounded-sm dark:bg-dark-700 dark:border-#4C4D4F flex [&:o-button-base]:!c-context',
      'o-demo_actions': 'flex justify-end pt-3 gap-2 p2 border-1 border-x-0 border-solid border-gray/20',
      'o-demo_action_item':
